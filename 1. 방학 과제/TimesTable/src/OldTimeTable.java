public class OldTimeTable {
	...
	private static void printStepNine() {
		System.out.println("구구단 9단 입니다.");
	...
	private static void printStepEight() {
		System.out.println("구구단 8단 입니다.");
	...
	private static void printStepSeven() {
		System.out.println("구구단 7단 입니다.");
	...
	private static void printStepSix() {
		System.out.println("구구단 6단 입니다.");
	...
	private static void printStepFive() {
	...
	private static void printStepFour() {
		System.out.println("구구단 4단 입니다.");
